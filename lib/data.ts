...
import type { Section, Agent, AgentStep, AgentResultats, CaseStudy, AbonnementDetail } from '@/types'
...
export const agents: Agent[] = [
  ...
  // --- Sous-section Prospection ---
  {
    ...
    prix_mensuel: 182,
    abonnement_details: [
      { label: 'Recherche Google (SerpAPI)', amount: 25 },
      { label: 'Enrichissement données entreprises (Drop Contact & Hunter)', amount: 59 },
      { label: 'Abonnement IA (Claude)', amount: 15 },
      { label: 'Envoi des mails (Brevo)', amount: 13.5 },
      { label: 'Maintenance', amount: 69.5 },
    ],
    delai: '2-3 semaines',
    roi: '3-6 semaines',
    is_golden: false,
  ...
  },
  {
    ...
    prix_mensuel: 267,
    abonnement_details: [
      { label: 'LinkedIn Sales Navigator (annuel)', amount: 89 },
      { label: 'La Growth Machine (annuel)', amount: 100 },
      { label: 'Abonnement IA (Claude)', amount: 8 },
  ...
  // --- Sous-section Création de contenu ---
  {
    ...
    prix_mensuel: 110,
    abonnement_details: [
      { label: 'Abonnement IA (Claude)', amount: 20 },
      { label: 'Génération d\'images IA (Nano Banana)', amount: 15 },
      { label: 'Recherche Google tendances (SerpAPI)', amount: 5 },
      { label: 'Maintenance', amount: 70 },
    ],
    delai: '2-3 semaines',
    roi: '6-12 semaines',
