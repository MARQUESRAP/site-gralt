...
const agents: AgentSeed[] = [
  ...
  // --- Sous-section Vente ---
  {
    ...
    prix_setup_min: 3000,
    prix_setup_max: 5000,
    prix_mensuel_min: 250,
    prix_mensuel_max: 400,
    delai: '2-3 semaines',
    roi: '2-4 semaines',
    is_golden: false,
    color: '#0099AA',
  ...
  // --- Agent dore ---
  {
    ...
    prix_setup_min: 8000,
    prix_setup_max: 12000,
    prix_mensuel_min: 500,
    prix_mensuel_max: 700,
    delai: '4-5 semaines',
    roi: '4-8 semaines',
    is_golden: true,
    color: '#F5C842',
  ...
  // --- Sous-section Visibilite & Diffusion ---
  {
    ...
    is_golden: false,
    color: '#7928CA',
    case_study_slug: 'campagne-avis-google-btp',
  ...
  // --- Agent dore ---
  {
    ...
    prix_setup_min: 6000,
    prix_setup_max: 9000,
    prix_mensuel_min: 450,
    prix_mensuel_max: 650,
    delai: '3-4 semaines',
    roi: '6-12 semaines',
    is_golden: true,
    color: '#F5C842',
  ...
  // --- Agent dore ---
  {
    ...
    prix_setup_min: 7000,
    prix_setup_max: 10000,
    prix_mensuel_min: 400,
    prix_mensuel_max: 600,
    delai: '3-4 semaines',
    roi: '4-8 semaines',
    is_golden: true,
    color: '#F5C842',
  ...
  // --- Agent dore ---
  {
    ...
    prix_setup_min: 9000,
    prix_setup_max: 14000,
    prix_mensuel_min: 600,
    prix_mensuel_max: 850,
    delai: '5-6 semaines',
    roi: '6-12 semaines',
    is_golden: true,
    color: '#F5C842',
...
const caseStudies: CaseStudySeed[] = [
  // ── 5 detailed ──
  {
    ...
    slug: 'vedet',
    type: 'detailed',
    context: 'Application personnelle de gestion LinkedIn permettant de maintenir une presence reguliere sans y consacrer des heures chaque semaine.',
    problem: 'Passer 3-5h/semaine a creer et publier du contenu LinkedIn manuellement, avec un rythme irregulier et une qualite variable.',
    solution: '8 workflows n8n, Claude API, Supabase, Fal.ai. Chaque lundi : 8 suggestions de posts generees automatiquement. Validation de 2 posts en 15 minutes. Publication automatique mardi et jeudi aux horaires optimaux.',
    tech: ['n8n (8 workflows)', 'Claude API', 'Supabase', 'Fal.ai'],
    results: [
      '3-5h/semaine reduites a 15 min de validation',
      'Publication reguliere et constante',
      'Qualite de contenu professionnelle et coherente',
    ],
  ...
  },
  {
    ...
    type: 'detailed',
    context: "Systeme de gestion de contenu LinkedIn adapte a l'univers goodies/objets publicitaires pour un imprimeur en ligne.",
    problem: 'Absence de presence LinkedIn structuree. Pas de temps ni de competences internes pour creer du contenu regulier.',
    solution: "Systeme similaire a Vedet, adapte a l'univers goodies/objets publicitaires. 8 workflows n8n pour la generation, validation et publication automatique.",
    tech: ['n8n (8 workflows)', 'Claude API', 'Supabase'],
    results: [
      'De 0 a 2 posts/semaine publies',
      'Moins de 2 minutes/semaine pour la validation',
      'Presence LinkedIn professionnelle maintenue sans effort',
    ],
    agent_slugs: ['camila'],
  },
  {
    ...
    slug: 'rapid-campaign',
    type: 'detailed',
    context: 'Application Next.js/Supabase/n8n construite pour Rapid-Pub, permettant de lancer des campagnes emailing centrees sur un produit specifique.',
    ...
    solution: 'Application avec navigation product-first : choisir un produit, identifier les professions ciblees, scraper les entreprises correspondantes, generer des emails personnalises, envoyer et relancer automatiquement.',
    ...
    results: [
      ...
      'Pipeline de prospects considérablement elargi',
    ],
  ...
  },
  {
    ...
    slug: 'jobsniper',
    type: 'detailed',
    context: "Systeme complet de prospection automatisee qui detecte des offres d'emploi revelant un besoin automatisable, puis contacte l'entreprise avec une proposition sur mesure.",
    problem: 'La prospection manuelle par cold emailing a des taux de reponse faibles. Identifier les entreprises ayant un vrai besoin est chronophage et imprecis.',
    solution: "8 workflows n8n : SCRAPE (detection d'offres), QUALIF (qualification du potentiel), ENRICH (enrichissement de l'entreprise), MATCH (matching avec les agents Gralt), PAGE (generation de landing page personnalisee sur audit.gralt.fr/slug), MAIL (generation d'email), SEND (envoi), TRACK (suivi et relances).",
    tech: ['n8n (8 workflows)', 'Claude API', 'Supabase', 'Next.js'],
    results: [
      'Dizaines de prospects qualifies/semaine',
      "Taux de reponse superieur au cold emailing classique",
      'Landing pages personnalisees pour chaque prospect',
      'Systeme entierement automatise de bout en bout',
    ],
  ...
  },
  {
    ...
    problem: "Suivi de chantier papier, rapports oublies ou incomplets, ruptures de stock non anticipees, perte de temps administratif enorme pour les equipes terrain.",
    solution: "Application web progressive (PWA) fonctionnant hors reseau grace aux service workers. Photos avant/apres, rapports de chantier, suivi de stock, panneau admin complet.",
    tech: ['React (PWA)', 'Supabase', 'Service Workers'],
    results: [
      '-60-70% de temps administratif',
      'Rapports de chantier remplis systematiquement',
      'Fin des ruptures de stock non anticipees',
  ...
  // ── 3 mini ──
  {
    ...
    slug: 'ankes',
    type: 'mini',
    context: "Application Next.js/Supabase ultra-intuitive concue pour des artisans non-techniques, permettant de gerer devis et factures simplement.",
    problem: 'Artisans non-techniques perdant du temps avec des outils de facturation complexes ou le papier.',
    solution: "Devis et factures en quelques secondes, mentions legales automatiques, relances automatiques d'impayes.",
    tech: ['Next.js', 'Supabase'],
    results: [
      'Devis/factures generes en quelques secondes',
      'Mentions legales toujours conformes',
      'Relances automatiques des impayes',
    ],
    agent_slugs: ['mila', 'bruno'],
  },
  {
    title: "Campagne d'avis Google BTP",
    slug: 'campagne-avis-google-btp',
    type: 'mini',
    context: "Campagne emailing ciblee vers 1 000 clients d'une base BTP pour generer des avis Google positifs.",
    problem: 'Note Google stagnante malgre des prestations de qualite. Pas de processus systematique pour collecter des avis.',
    solution: "Emails personnalises envoyes a 1 000 clients avec lien direct vers Google pour deposer un avis. Segmentation et personnalisation pour maximiser le taux de reponse.",
    tech: ['n8n', 'Email automation'],
    results: [
      'Hausse significative de la note Google',
      'Flux d\'avis 5 etoiles genere',
      'Processus reproductible pour les futures campagnes',
    ],
    agent_slugs: ['gabriel', 'luna'],
  },
  {
    title: 'Application de planning pour formatrice independante',
    slug: 'planning-formatrice',
    type: 'mini',
    context: "2 applications interconnectees pour une formatrice independante : une app pour les ecoles (reservation de creneaux) et une app personnelle (vue planning et export PDF).",
    problem: 'Gestion de planning manuelle entre plusieurs ecoles, risque de double-booking, pas de vue d\'ensemble, exports PDF chronophages.',
    solution: "App ecoles pour la reservation de creneaux + app personnelle avec vue planning complete et export PDF. Integration Google Calendar et notifications automatiques.",
    tech: ['Next.js', 'Supabase', 'Google Calendar API'],
    results: [
      'Planning centralise et auto-gere',
      'Zero double-booking',
      'Notifications automatiques a toutes les parties',
