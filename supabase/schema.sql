...
CREATE TABLE agents (
  ...
  prix_setup_min INTEGER NOT NULL DEFAULT 0,
  prix_setup_max INTEGER NOT NULL DEFAULT 0,
  prix_mensuel_min INTEGER NOT NULL DEFAULT 0,
  prix_mensuel_max INTEGER NOT NULL DEFAULT 0,
